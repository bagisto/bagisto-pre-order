                            ...
                            <div slot="body">
                                ...
                                @foreach ($customAttributes as $attribute)
                                    ...
                                    <?php
                                        ...
                                        if(core()->getConfigData('preorder.settings.general.enable_preorder') == '0') {
                                                if ($attribute->code == 'allow_preorder') {
                                                    continue;
                                                }
                                                if ($attribute->code == 'preorder_availability') {
                                                    continue;
                                                }
                                                if ($attribute->code == 'preorder_qty') {
                                                    continue;
                                                }
                                        }
