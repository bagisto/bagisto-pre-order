                                            ...
                                            @foreach ($order->items as $item)
                                                <tr>
                                                    ...
                                                    <td data-value="{{ __('shop::app.customer.account.order.view.product-name') }}">
                                                        ...
                                                        @if ($preOrderItem = $preOrderItemRepository->resetScope()->findOneByField('order_item_id', $item->id))
                                                            <div class="pre-order-item-info">
                                                                ...
                                                                <span class="row" style="padding-left: 15px!important;">
                                                    ...
                                                    <td data-value="{{ __('shop::app.customer.account.order.view.grand-total') }}">
                                                        ...
                                                        @if ($canBeComplete['isInStock'] && $canBeComplete['condition'])
                                                            <a href="{{ route('preorder.shop.preorder.complete', $preOrderItem->token) }}" style="margin-top: 5px; margin-left: 10px;" class="btn btn-primary btn-lg">{{ __('preorder::app.shop.products.complete-preorder') }}</a>
                                                        @endif
                                                        @if (!$canBeComplete['isInStock'] && $canBeComplete['condition'])
                                                            <a href="#" disabled style="margin-top: 5px; margin-left: 10px;" class="btn btn-primary btn-lg">{{ __('preorder::app.shop.products.available-soon-for-preorder') }}</a>
                                                        @endif
                                                        @if (!$canBeComplete['isInStock'] && !$canBeComplete['condition'])
                                                            <a href="#"></a>
                                                        @endif
