    ...
    @if ($product->totalQuantity() < 1 && $product->allow_preorder && core()->getConfigData('preorder.settings.general.enable_preorder'))
        @push('css')
            <style>
                ...
                a.unset.compare-icon.text-right {
                    margin-left: -18px;
                }
                ...
                .rtl a.unset.compare-icon.text-right {
                    margin-left: 0px;
                    }
            </style>
        @endpush
...
@if (core()->getConfigData('preorder.settings.general.preorder_type') == 'complete')
    @push('css')
            <style>
                a.unset.compare-icon.text-right {
                    margin-left: 0px;
                                ...
                                <div class="right col-lg-7 col-md-6">
                                    ...
                                    <div class="row info">
                                        ...
                                        <div class="product-actions">
                                            @if ($product->type != 'configurable' && $product->type == 'simple')
                                                @if ($product->totalQuantity() < 1 && $product->allow_preorder && core()->getConfigData('preorder.settings.general.enable_preorder'))
                                                    @include('preorder::shop.velocity.products.add-to-cart', [
                                                        'form' => false,
                                                        'product' => $product,
                                                        'showCartIcon' => false,
