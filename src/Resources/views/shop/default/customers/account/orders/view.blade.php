                                                ...
                                                <tr>
                                                    ...
                                                    <td data-value="{{ __('shop::app.customer.account.order.view.grand-total') }}">
                                                        ...
                                                        @if ($canBeComplete['isInStock'] && $canBeComplete['condition'])
                                                            <a href="{{ route('preorder.shop.preorder.complete', $preOrderItem->token) }}" style="margin-top: 5px" class="btn btn-primary btn-sm">{{ __('preorder::app.shop.products.complete-preorder') }}</a>
                                                        @endif
                                                        @if (!$canBeComplete['isInStock'] && $canBeComplete['condition'])
                                                            <a href="#" disabled style="margin-top: 5px" class="btn btn-primary btn-sm">{{ __('preorder::app.shop.products.available-soon-for-preorder') }}</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
